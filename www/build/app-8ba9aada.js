const BUILD = {"allRenderFn":true,"cmpDidLoad":false,"cmpDidUnload":false,"cmpDidUpdate":false,"cmpDidRender":false,"cmpWillLoad":false,"cmpWillUpdate":false,"cmpWillRender":false,"connectedCallback":false,"disconnectedCallback":false,"element":false,"event":false,"hasRenderFn":false,"lifecycle":false,"hostListener":false,"hostListenerTargetWindow":false,"hostListenerTargetDocument":false,"hostListenerTargetBody":false,"hostListenerTargetParent":false,"hostListenerTarget":false,"member":true,"method":false,"mode":false,"noVdomRender":true,"observeAttribute":false,"prop":false,"propBoolean":false,"propNumber":false,"propString":false,"propMutable":false,"reflect":false,"scoped":false,"shadowDom":false,"slot":false,"slotRelocation":false,"state":false,"style":false,"svg":false,"updatable":true,"vdomAttribute":false,"vdomClass":false,"vdomFunctional":false,"vdomKey":false,"vdomListener":false,"vdomRef":false,"vdomRender":false,"vdomStyle":false,"vdomText":false,"watchCallback":false,"taskQueue":true,"lazyLoad":true,"hydrateServerSide":false,"cssVarShim":true,"hydrateClientSide":false,"isDebug":false,"isDev":true,"lifecycleDOMEvents":false,"profile":false,"hotModuleReplacement":true,"cssAnnotations":true};
const NAMESPACE = 'app';
...
export { patchEsm as a, bootstrapLazy as b, globals as g, patchBrowser as p };
