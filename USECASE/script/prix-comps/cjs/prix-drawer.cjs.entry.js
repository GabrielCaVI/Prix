...
class TestMenu {
    ...
    render() {
        return (__chunk_1.h("div", null, __chunk_1.h("div", { id: "drawer-wrapper" }, __chunk_1.h("div", { id: "drawer-content" }, __chunk_1.h("slot", { name: "drawer-content" })))));
    }
